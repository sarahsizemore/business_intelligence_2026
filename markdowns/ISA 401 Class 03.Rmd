...
- **R Markdowns:** The relative path is based on the location of the RMarkdown file. **This is true for when you knit the file.** directory (assuming that you are working in a project.)
...
We are using the **jsonlite** package to read json data. 
...
# optional you can also go one by one and change list columns to single cols
# this will depend on your goal for the data analysis
# it depends on your subsequent step 
...
Note that the unnesting can impact the number of rows for your data
